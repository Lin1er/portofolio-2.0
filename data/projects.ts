...
export const projects: Project[] = [
  ...
  },
  {
    title: "ProdBooster",
    description:
      "Terminal-based productivity app for developers who live in the terminal. Features task management, calendar events, and quick notes with SQLite persistence. Built with Bubble Tea TUI framework and designed to auto-launch on TTY login.",
    image:
  ...
  },
  {
    ...
    description:
      "Comprehensive Islamic boarding school management system handling student permits, parent notifications, and security verification. Features role-based access (Admin, Mustahiq, Wali, Satpam), real-time photo uploads, and Docker deployment ready.",
    image:
  ...
  },
  {
    title: "eLibrary",
    description:
      "Digital library management system for efficient book cataloging, borrowing, and returns. Includes advanced search, overdue notifications, and multi-user support with role-based permissions for admins, staff, and members.",
    image:
